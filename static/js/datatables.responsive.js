...
function ResponsiveDatatablesHelper(tableSelector, breakpoints, options) {
    ...
    // Index of the th in the header tries that stores where the attribute
    //     data-class="expand"
    // is defined.
    this.expandColumn = undefined;

    // Stores the break points defined in the table header.
    // Each th in the header try may contain an optional attribute like
    //     data-hide="phone, tablet"
    // These attributes, and the breakpoint object will be used to create this
    // object.
    this.breakpoints = {
        /**
...
ResponsiveDatatablesHelper.prototype.showHideColumns = function () {
    ...
    for (var j = 0, m = this.columnsHiddenIndexes.length; j < m; j++) {
        this.tableElement.fnSetColumnVis(this.columnsHiddenIndexes[j], false, false);
    }
